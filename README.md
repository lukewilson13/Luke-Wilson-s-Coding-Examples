...
### JavaScript
This Alarm file is part of a React Native Timer Application project that I completed with a partner in the Spring of 2024. There were other components to this app (a stopwatch and a timer) but my partner and I collaborated on those so it is not entirely my own work. However, all of the code for the Alarm component was written entirely by myself.



This will likely be the most difficult project for you to view. I used Expo to build the application, but the SDK is outdated (my code is written for version 51.0, while the current SDK is on version 53.0). For this reason, I can't view the app from my phone, but I can still view it on my computer.
